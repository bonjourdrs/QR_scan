...
proc create_root_design { parentCell } {
  ...
  # Create instance: QR_scan_0, and set properties
  set QR_scan_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:QR_scan:1.0 QR_scan_0 ]
  ...
  set write_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:write:1.0 write_0 ]
  ...
  # Create port connections
  connect_bd_net -net QR_scan_0_ap_return [get_bd_ports led] [get_bd_pins QR_scan_0/ap_return] [get_bd_pins led_0/bit]
  connect_bd_net -net QR_scan_0_imagein_V_address0 [get_bd_pins QR_scan_0/imagein_V_address0] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net QR_scan_0_imagein_V_ce0 [get_bd_pins QR_scan_0/imagein_V_ce0] [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins QR_scan_0/imagein_V_q0] [get_bd_pins blk_mem_gen_0/doutb]
  ...
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins QR_scan_0/ap_clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins csi2dvp_0/vid_clk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins write_0/pclk]
  ...
  connect_bd_net -net csi2dvp_0_hdata [get_bd_pins csi2dvp_0/hdata] [get_bd_pins write_0/hdata]
  connect_bd_net -net csi2dvp_0_vdata [get_bd_pins csi2dvp_0/vdata] [get_bd_pins write_0/vdata]
  connect_bd_net -net csi2dvp_0_vid_active_video [get_bd_pins csi2dvp_0/vid_active_video] [get_bd_pins write_0/de]
  connect_bd_net -net csi2dvp_0_vid_data [get_bd_pins csi2dvp_0/vid_data] [get_bd_pins write_0/v_data]
  connect_bd_net -net csi2dvp_0_vid_hsync [get_bd_pins csi2dvp_0/vid_hsync] [get_bd_pins write_0/hs]
  connect_bd_net -net csi2dvp_0_vid_vsync [get_bd_pins csi2dvp_0/vid_vsync] [get_bd_pins write_0/vs]
  connect_bd_net -net d_1 [get_bd_ports d] [get_bd_pins led_0/d]
  ...
  connect_bd_net -net led_0_q [get_bd_ports q] [get_bd_pins led_0/q]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_0_200M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins csi2_d_phy_rx_0/in_delay_clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_200M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_200M_peripheral_aresetn [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_200M/peripheral_aresetn]
  connect_bd_net -net write_0_addra [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins write_0/addra]
  connect_bd_net -net write_0_binary [get_bd_pins rgb2dvi_0/vid_pData] [get_bd_pins write_0/binary]
  connect_bd_net -net write_0_deout [get_bd_pins rgb2dvi_0/vid_pVDE] [get_bd_pins write_0/deout]
  connect_bd_net -net write_0_douta [get_bd_pins blk_mem_gen_0/dina] [get_bd_pins write_0/douta]
  connect_bd_net -net write_0_ena [get_bd_pins blk_mem_gen_0/wea] [get_bd_pins write_0/ena]
  connect_bd_net -net write_0_hsout [get_bd_pins rgb2dvi_0/vid_pHSync] [get_bd_pins write_0/hsout]
  connect_bd_net -net write_0_vsout [get_bd_pins rgb2dvi_0/vid_pVSync] [get_bd_pins write_0/vsout]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins QR_scan_0/ap_start] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins QR_scan_0/ap_rst] [get_bd_pins xlconstant_2/dout]
