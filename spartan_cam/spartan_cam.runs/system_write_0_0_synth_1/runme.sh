...
HD_PWD='E:/Desktop/night0717/spartan_cam/spartan_cam.runs/system_write_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_write_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_write_0_0.tcl
