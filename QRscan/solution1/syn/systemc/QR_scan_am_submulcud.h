...
#ifndef __QR_scan_am_submulcud__HH__
#define __QR_scan_am_submulcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(QR_scan_am_submulcud) {
    ...
    SC_CTOR(QR_scan_am_submulcud):  simcore_am_0_U ("simcore_am_0_U") {
