...
#ifndef __QR_scan_am_submuleOg__HH__
#define __QR_scan_am_submuleOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(QR_scan_am_submuleOg) {
    ...
    SC_CTOR(QR_scan_am_submuleOg):  simcore_am_2_U ("simcore_am_2_U") {
