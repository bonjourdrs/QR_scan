...
#ifndef __QR_scan_mul_mul_1bkb__HH__
#define __QR_scan_mul_mul_1bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(QR_scan_mul_mul_1bkb) {
    ...
    SC_CTOR(QR_scan_mul_mul_1bkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
